  ...
  useEffect(() => {
    ...
    const renderFrame = () => {
      ...
      const getPosOnPerimeter = (progress) => {
        // Wrap progress cleanly between 0.0 and 1.0
      ...
      const orbs = [
        { r: 59,  g: 130, b: 246, speed: 0.2,   offset: 0.00, sizeScale: 1.4 }, // Blue
      ...
      orbs.forEach((orb, index) => {
        ...
        const size = Math.max(0, baseSize * orb.sizeScale * (1 + vol * 2.5 * organicMultiplier));
      ...
      // MAGIC TRICK for Apple Intelligence pure "inner edge glow":
